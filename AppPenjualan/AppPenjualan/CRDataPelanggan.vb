...
Public Class CRDataPelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualan.CRDataPelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDataPelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDataPelanggan = New CRDataPelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
