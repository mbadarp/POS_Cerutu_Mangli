...
Public Class CRV_DataCerutu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualan.CRV_DataCerutu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRV_DataCerutu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRV_DataCerutu = New CRV_DataCerutu()
        rpt.Site = Me.Site
        Return rpt
    End Function
